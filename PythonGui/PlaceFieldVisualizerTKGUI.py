...
def streaming():
    ...
    global neuronIDList, neuronMapIDList, countID, firingRates, n_received, t_curr, t_pass, neuronNumber, axcolor
    global is_streaming
            ...
            if len(data) == HELLO_STR_SIZE: # Test
                ...
                for ii in range(0, spikeReceived):
                    ...
                    if spikeID in neuronIDList:
                        ...
                        neuronMapIDList.append(np.zeros((N_GRID, N_GRID), dtype=np.int64))
                ...
                # Update firing rates
                firingRates = (np.array(countID) / float(window))
